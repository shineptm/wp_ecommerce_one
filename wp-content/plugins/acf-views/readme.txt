...
= Is it possible to display sub fields for nested repeater? =

It's not currently possible, to display nested repeater sub fields within an ACF View, due to UI limitations.
